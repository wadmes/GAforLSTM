...
# Data Parameters
tf.flags.DEFINE_string("data_file", "../data/apple_news_data.csv", "Data source for the negative data.")
# Eval Parameters
...
if FLAGS.eval_train:
    ...
    data=pd.read_csv('../data/apple_news_data.csv')
...
out_path = '../data/sentiment_prediction.csv'
